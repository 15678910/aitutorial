...
export const courseThemes: Record<string, CourseTheme> = {
  ...
  'prompt-engineering': {
    ...
    bg: 'bg-[#F97316]',
    bgLight: 'bg-[#FFF7ED]',
    bgGradient: 'bg-gradient-to-br from-[#F97316] to-[#FB923C]',
    text: 'text-white',
    accent: 'text-[#EA580C]',
  ...
  'claude-tool-use': {
    ...
    bg: 'bg-[#84CC16]',
    bgLight: 'bg-[#F7FEE7]',
    bgGradient: 'bg-gradient-to-br from-[#84CC16] to-[#A3E635]',
    text: 'text-[#29264c]',
    accent: 'text-[#65A30D]',
  ...
  'extended-thinking': {
    ...
    bg: 'bg-[#A855F7]',
    bgLight: 'bg-[#FAF5FF]',
    bgGradient: 'bg-gradient-to-br from-[#A855F7] to-[#C084FC]',
    text: 'text-white',
    accent: 'text-[#9333EA]',
  ...
  'claude-vision': {
    ...
    bg: 'bg-[#E11D48]',
    bgLight: 'bg-[#FFF1F2]',
    bgGradient: 'bg-gradient-to-br from-[#E11D48] to-[#FB7185]',
    text: 'text-white',
    accent: 'text-[#BE123C]',
  ...
  'ai-evaluation': {
    ...
    bg: 'bg-[#64748B]',
    bgLight: 'bg-[#F8FAFC]',
    bgGradient: 'bg-gradient-to-br from-[#64748B] to-[#94A3B8]',
    text: 'text-white',
    accent: 'text-[#475569]',
...
export const chapterColors: Record<string, string[]> = {
  ...
  'prompt-engineering': ['#F97316', '#EA580C', '#FB923C', '#C2410C'],
  'mcp-mastery': ['#0EA5E9', '#0284C7', '#38BDF8', '#0369A1'],
  'claude-tool-use': ['#84CC16', '#65A30D', '#A3E635'],
  'extended-thinking': ['#A855F7', '#9333EA', '#C084FC'],
  'claude-vision': ['#E11D48', '#BE123C', '#FB7185'],
  'ai-evaluation': ['#64748B', '#475569', '#94A3B8'],
}
